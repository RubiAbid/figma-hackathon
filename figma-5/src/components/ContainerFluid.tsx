...
const ContainerFluid = () => {
  return (
    <div className="flex flex-col sm:flex-col lg:flex-row sm:gap-[20px] items-center sm:translate-x-[60px] lg:translate-y-0 translate-y-8 sm:translate-y-[100px] lg:translate-x-0 justify-between lg:w-full w-[254px] md:w-[1440px] h-auto md:h-[682px]">
      {/* Image */}
      <div className="relative order-2 md:order-1 lg:order-1 w-[270px] sm:w-[500px] md:w-[725px] sm:h-[300px] md:h-[682px] sm:left-[-5px] md:left-[-137px] top-[-24px] translate-y-[120px] lg:translate-y-0 lg:translate-x-[140px]">
        <Image 
          src="/asian-woman.png" 
      ...
      {/* Text Content */}
      <div className="flex flex-col lg:justify-center justify-center items-center lg:items-start p-0 gap-[30px] w-full sm:w-[300px] md:w-[573px] h-auto sm:h-[300px] md:h-[326px] lg:order-2 order-1 md:order-2">
