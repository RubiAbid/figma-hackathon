...
const Carusel = () => {
  return (
    <div className="flex items-center justify-center lg:flex-row w-[280px] p-[32px_0px] gap-[40px] lg:w-full sm:w-[430px] md:w-[600px] lg:h-auto bg-[#23856D] flex-col sm:flex-col md:flex-col sm:gap-[40px] md:gap-[60px] lg:gap-[80px] lg:translate-x-0 sm:translate-x-[60px] md:translate-x-0 lg:translate-y-0 sm:translate-y-[70px] md:translate-y-0">
      <div className="flex flex-col items-center justify-center lg:items-start lg:justify-start p-[20px_0_0] gap-[50px] w-full sm:w-[500px] md:w-[509px] lg:w-[509px] sm:h-[400px] md:h-[432px] lg:translate-y-0 sm:translate-y-[-30px] md:translate-y-0">
      ...
      <div className="w-full sm:w-[400px] lg:translate-x-0 sm:translate-x-4 md:w-[443px] lg:w-[443px] sm:h-[560px] lg:translate-y-0 translate-y-8 md:translate-y-0 md:h-[660px] flex-none order-0 flex-grow-0 mt-12 sm:mt-8 md:mt-0">
        <Image 
