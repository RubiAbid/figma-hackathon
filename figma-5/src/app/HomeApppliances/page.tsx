...
<div className="lg:w-full max-w-[1440px] w-[300px] bg-[#FAFAFA] flex flex-col lg:flex-row px-[20px]  sm:px-[17px] lg:px-[83px] gap-[20px] lg:gap-[30px]">
  {/* Left Image Section */}
...
<nav className="flex justify-center items-center lg:w-full w-[380px] h-[72px] mx-auto lg:translate-x-0 sm:translate-x-[-140px] translate-x-[-33px]">
...
<div className="flex flex-col lg:flex-row sm:flex-col gap-[30px] lg:w-full w-[250px] sm:w-[2000px] lg:translate-x-[200px] sm:translate-x-[5px] translate-x-[-60px]  sm:h-[427px] mx-auto">
...
{/* Text Section */}
<div className="flex flex-col items-start sm:w-[280px] lg:w-[332px] w-[290px]">
  ...
  <li className="flex items-center gap-[20px] sm:gap-[10px] lg:w-full w-[400px] h-[24px] sm:h-[20px] ">
    <Image 
      src="/Vector (7).png" 
      alt="Chevron Left" 
  ...
  <li className="flex items-center gap-[20px] sm:gap-[10px] lg:w-full w-[400px] h-[24px] sm:h-[20px]">
    <Image 
      ...
      height={16} 
    />
    <h5 className="font-montserrat font-semibold lg:text-[14px] text-[13px] lg:translate-x-0 translate-x-[-20px] leading-[24px] text-[#737373] sm:text-[12px] sm:leading-[16px]">
      The quick fox jumps over the lazy dog
    </h5>
  </li>
  <li className="flex items-center gap-[20px] sm:gap-[10px] lg:w-full w-[400px] h-[24px] sm:h-[20px]">
    <Image 
      ...
      height={16} 
    />
    <h5 className="font-montserrat font-semibold lg:translate-x-0 translate-x-[-20px] lg:text-[14px] text-[13px] leading-[24px] text-[#737373] sm:text-[12px] sm:leading-[16px]">
      The quick fox jumps over the lazy dog
    </h5>
  </li>
  <li className="flex items-center gap-[20px] sm:gap-[10px] lg:w-full w-[400px] h-[24px] sm:h-[20px]">
    <Image 
      ...
      height={16} 
    />
    <h5 className="font-montserrat lg:translate-x-0 translate-x-[-20px] font-semibold lg:text-[14px] text-[13px] leading-[24px] text-[#737373] sm:text-[12px] sm:leading-[16px]">
      The quick fox jumps over the lazy dog
    </h5>
  </li>
</ul>
...
<div className="flex flex-col items-center bg-[#FFFFFF] gap-[24px] w-full h-[1086px] bottom-0 lg:ml-0 -ml-4 lg:translate-y-0 sm:translate-y-[750px] lg:translate-x-0 sm:translate-x-[-110px]">
...
<div className="flex lg:flex-row flex-col  gap-[30px] lg:w-full w-[400px] lg:translate-x-0 translate-x-[350px]">
  {/* First Picture */}
...
{/* Footer Section */}
<div className="flex lg:flex-row flex-col sm:translate-x-[450px] lg:translate-x-10 items-center translate-y-[-25px] p-0 w-full h-[200px] mt-[-15px] transform">
  <div className="flex lg:flex-row flex-col lg:gap-4 gap-10 sm:w-full lg:translate-y-0 translate-y-[-120px] lg:translate-x-0 translate-x-[-50px]">
